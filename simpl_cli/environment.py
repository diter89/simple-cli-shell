...
class EnvironmentDetector:
    ...
    def get_git_status(self) -> Optional[Dict[str, str]]:
        ...
        try:
            ...
            if branch_result.returncode == 0:
                ...
                git_info = {"branch": branch, "display": f"git:{branch}", **status_info}
    ...
    def _get_git_status_indicators(self) -> Dict[str, any]:
        try:
            ...
            return {"has_changes": False, "ahead": 0, "behind": 0, "status_symbol": "○"}
    ...
    def get_status_bar_info(self) -> str:
        ...
        if system["cpu_percent"] > 80 or system["memory_percent"] > 85:
            status_parts.append(
                f" CPU:{system['cpu_percent']:.0f}% MEM:{system['memory_percent']:.0f}%"
            )
        else:
            status_parts.append(
                f"CPU:{system['cpu_percent']:.0f}% MEM:{system['memory_percent']:.0f}%"
